...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-properties-properties-module"], {
  ...
  function srcAppPagesPropertiesPropertiesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PropertiesComponent = /*#__PURE__*/function () {
      function PropertiesComponent(appSettings, appService, mediaObserver, platformId) {
        var _this9 = this;
    ...
    }), __metadata("design:paramtypes", [_app_settings__WEBPACK_IMPORTED_MODULE_4__["AppSettings"], _app_service__WEBPACK_IMPORTED_MODULE_5__["AppService"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["MediaObserver"], Object])], PropertiesComponent);
    /***/
  },
  ...
  function srcAppPagesPropertiesPropertiesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PropertiesModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
      declarations: [_properties_component__WEBPACK_IMPORTED_MODULE_6__["PropertiesComponent"], _property_property_component__WEBPACK_IMPORTED_MODULE_7__["PropertyComponent"]],
  ...
  function srcAppPagesPropertiesPropertyPropertyComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PropertyComponent = /*#__PURE__*/function () {
      function PropertyComponent(appSettings, appService, activatedRoute, embedService, fb, meta, document) {
        ...
        this.meta.addTags([{
          ...
          name: 'twitter:image',
          content: 'https://fakeimg.pl/600x400/'
        }, {
          name: 'og:title',
          content: 'Property Name'
        }, {
      ...
      _createClass(PropertyComponent, [{
        ...
        value: function getPropertyById(id) {
          ...
          this.appService.getPropertyById(id).subscribe(function (data) {
            ...
            var port = _this13.document.location.port ? ':' + _this13.document.location.port + '/' : '/';
            var url = _this13.document.location.protocol + '//' + _this13.document.location.hostname + port;

            _this13.meta.updateTag({
              name: 'twitter:title',
              content: _this13.property.title
            });

            _this13.meta.updateTag({
              name: 'twitter:description',
              content: _this13.property.desc
            });

            _this13.meta.updateTag({
              name: 'twitter:image',
              content: url + _this13.property.gallery[0].medium
            });
    ...
    }), __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"], src_app_app_service__WEBPACK_IMPORTED_MODULE_3__["AppService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], ngx_embed_video__WEBPACK_IMPORTED_MODULE_7__["EmbedVideoService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__["Meta"], Object])], PropertyComponent);
    /***/
  }
}]);
